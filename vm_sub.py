...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("maykhan/ipinfo")
    client.subscribe("maykhan/date")
    client.subscribe("maykhan/#")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("maykhan/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("maykhan/date", on_message_from_date)
